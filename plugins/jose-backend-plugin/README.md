...
Cinco skills para el ciclo de un servicio backend: construir la imagen, desplegarla,
...
| `go-hexagonal-multitenant-skills` | propia, extraída de `bicom-report-stock-movements` | propia |
